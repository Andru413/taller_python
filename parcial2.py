...
#1010 Admin, clave: 1031
#1020 vendendor clave: 2020
#1030 operario clave: 123456

lista_usuarios = [
    {"Usuario": "1010", "Clave": "1031", "Rol": "admin"},
    {"Usuario": "1020", "Clave": "2020", "Rol": "vendedor"},
    {"Usuario": "1030", "Clave": "123456", "Rol": "Operario"},
]
...
class SistemaLogin:
    def __init__(self, master):
        self.master = master
        self.master.title("Inicio de sesion")
    ...
    def crear_login(self):
        ...
        tk.Button(
            ...
            command=lambda: self.verificar_login()
        ).pack(pady=10)
    ...
    def verificar_login(self):
        ...
        try:
            ...
            # aca abre las ventanas segun el rol del usuario
    ...
    def registrar_log(self, usuario, mensaje, estado):
        """Guarda el historial de inicio de sesion"""
    ...
    def ventana_admin(self):
        ...
        tk.Button(self.master, text="Ver historial", font=("Arial", 12),
                  bg="#ffffff", fg="#000000", command=lambda: self.mostrar_log()).pack(pady=5)
        tk.Button(self.master, text="Cerrar sesion", font=("Arial", 12),
                  bg="#ffffff", fg="#000000", command=lambda: self.crear_login()).pack(pady=5)
    ...
    def ventana_vendedor(self):
        ...
        tk.Button(self.master, text="Cerrar sesion", font=("Arial", 12),
                  bg="#ffffff", fg="#000000", command=lambda: self.crear_login()).pack(pady=10)
    ...
    def mostrar_log(self):
        ...
        log_window.title("Historial de inicio de sesion")
        log_window.geometry("400x250")
        log_window.configure(bg="#f0f0f0")
        log_window.resizable(False, False)

        tk.Label(log_window, text="Historial de inicio de sesion", font=("Arial", 14, "bold"),
                 bg="#f0f0f0").pack(pady=10)

        for log in self.historial:
            tk.Label(log_window, text=log, font=("Arial", 10), bg="#f0f0f0").pack(anchor="w")

        tk.Button(log_window, text="Cerrar", command=lambda: log_window.destroy(),
